...
<head>
    ...
    <title> جدول المدرس</title>


    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <link rel="stylesheet" href="CSS/inst_schedule.css">
</head>
...
<body>
    ...
    $schedule = get_inst_sch($user_id);

    $shours = 0;
    ?>

    <div class="container">
        <table class="inst_sched" >
            <thead>
                <tr>
                    <th colspan=10 style='text-align: center;  font-family: Arabic Typesetting;'>
                        <h2> <?php
                                echo "جدول المدرس في الفصل " . $semester . ' ' . $year;
                                ?> </h2>
                    </th>
                </tr>
                <th> رقم المادة </th>
