...
<div class="wrapper">
    <div class="sidebar">
        <ul>
            ...
            <li><a href="deprived_main.php"><i class="fas fa-project-diagram"></i>حرمان الطلبة</a></li>
            <?php }?>
            ...
            <?php }?>
            <?php if($_SESSION['role']>2){?>
              <li><a href="deprived_dept.php"><i class="fas fa-project-diagram"></i>طلبات الحرمان</a></li>
            <?php 
            //<li><a href="#"><i class="fas fa-blog"></i>Blogs</a></li>
            }?>
            <?php if($_SESSION['role']>1){?>
              <li><a href="withdraw_dept.php"><i class="fas fa-project-diagram"></i>طلبات الاسقاط</a></li>
            <?php }?>
